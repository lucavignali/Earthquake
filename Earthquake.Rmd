...
In this project we utilize data from Italian National Institute of Geophisics and Volcanology, that nicely provides Earhtquake catalogs from years 1000 to 2014 (great!) that includes events with Magnitudo >= 4.0 and Intensity (Mercalli) >= 5, and it is available [here](http://emidius.mi.ingv.it/CPTI15-DBMI15/).
